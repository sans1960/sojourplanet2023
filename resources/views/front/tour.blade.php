    ...
    <div class="container">
        <div class="row">
            <div class="col-md-10 d-flex flex-column mt-3 mx-auto">
                <div class="p-3 d-flex flex-column justify-content-start align-items-center" style="background-image: url({{Storage::url($tour->image)}});background-size:cover;height:200px;">
              ...
              <div class="open texto fs-5">
                ...
                <figure class="figure mt-3">
                  <img src="{{Storage::url($day->image)}}" class="w-75 figure-img img-fluid rounded d-block mx-auto" alt="...">
                ...
                <div class="open texto fs-5">
                 ...
                 <div id="map{{$loop->index}}" style="width:100%;height:400px">
                  <script>
                      var map = L.map('map{{$loop->index}}').setView([{{ $day->latitud }}, {{ $day->longitud }}], {{ $day->zoom }});
