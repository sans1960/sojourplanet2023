            ...
            <div class="accordion mb-5 mt-4" id="accordionExample">
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed  patua" onclick="" type="button"
    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            ...
            <div class=" d-flex justify-content-center mt-5 mb-5">
                <a href="{{ route('contacttour', $tour) }}"
                    class="btn btn-outline-dark border border-dark mt-5 patua px-3 py-2 rounded-pill">Plan a trip
                    here</a>
            </div>
