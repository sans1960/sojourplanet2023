    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-10 mx-auto d-flex justify-content-center align-items-center">
                <h3 class="patua text-center">The enormous historical and cultural legacy of its peoples and nations constitutes the cradle of Western civilization.</h3>
            </div>
        </div>
    </div>
...
">
        <div class="row ">
            ...
            <div class="col-md-4">
                ...
                <div class="d-flex justify-content-center mt-5">
                    <a href="{{ route('contactdestination',$destination) }}" class="btn btn-outline-dark border border-dark mt-5 patua px-3 py-2 rounded-pill">Start to plan my
                        trip</a>
                </div>
            </div>
        </div>
    ...
    <div class="container mt-5">
        <a href="{{route('destinationsights',$destination)}}" class="text-center nav-link text-dark patua fs-3">Lasts Sights from {{ $destination->name }} published</a>
    
        <div class="row mt-5 mb-5">
            @foreach ($sights as $sight)
            <div class="col-md-4 mb-2" >
                <a href="{{route('sight',$sight)}}" class="nav-link ">
                    <div class="d-flex flex-column justify-content-between text-white p-2 img-responsive" style="background-image:linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url({{Storage::url($sight->image)}});background-size:cover;height:200px; ">
