...
@endsection
@section('content')
    <div class="container-fluid d-flex justify-content-center align-items-center" style="background-image: url(https://cdn.pixabay.com/photo/2018/10/01/11/45/landscape-3715977_1280.jpg);background-size:cover;height:300px;background-position:center;">
      <h1 class="text-white">Our tailor-made trips</h1>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-md-8 mx-auto p-3">
                <h5 class="tipo patua">We offer tailor-made trips around the world, with a PREMIUM quality standard for a
                    complete experience, adapted to your tastes, desires, and needs. We provide you with all aspects of the trip booked in advance to ensure a stress-free vacation.</h5>
            </div>
        </div>
    ...
    <div class="container-fluid d-flex justify-content-center align-items-center" style="background-image: url(https://cdn.pixabay.com/photo/2021/08/02/16/22/beach-6517214_1280.jpg);background-size:cover;height:300px;background-position:center;">
        ...
        <div class="row">
            <div class="col-md-8 open">
              ...
              <div class="col-md-4 patua d-flex justify-content-star align-items-center flex-column px-5">
                ...
                <a href="{{ route('contactgeneral') }}" class="btn btn-outline-dark mt-3 patua p-2 mb-2 ">Start to plan my trip</a>
              </div>
        </div>
    </div>
    <div class="container-fluid d-flex justify-content-center align-items-center" style="background-image: url(https://cdn.pixabay.com/photo/2019/07/30/08/44/mosque-4372296_1280.jpg);background-size:cover;height:300px;background-position:center;">
        <h1 class="text-white">Our goal is to offer you the perfect trip for you.</h1>
      </div>
      <div class="container mt-5">
        <div class="row">
            <div class="col-md-8 mx-auto open">
              ...
              <a href="{{ route('contactgeneral') }}" class="btn btn-outline-dark mt-3 patua p-2 mt-2 mb-5 ">Start to plan my trip</a>
            </div>
        </div>
      </div>
@endsection
