    ...
    <div class="container mt-5 mb-5">
        <div class="row">
            <div class="col-md-8 mx-auto ">
                <h3 class=" patua text-center">We offer tailor-made trips around the world, with a PREMIUM quality standard for a
                    complete experience, adapted to your tastes, desires, and needs.</h3>
            </div>
        </div>
        ...
        <div class="row mt-5">
            <div class="col-md-8 open texto">
                <p class="fw-bold">We provide you with all aspects of the trip booked in advance to ensure a stress-free vacation.</p>
