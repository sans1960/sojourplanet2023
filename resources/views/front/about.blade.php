...
<div class="container-fluid d-flex justify-content-center align-items-center" style="background-image:linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url(https://cdn.pixabay.com/photo/2016/01/09/18/27/journey-1130732_1280.jpg);background-size:cover;height:300px;background-position:center;">
  ...
  <div class="container mt-5">
    <div class="row">
        ...
        <div class="row">
        <div class="col-md-8  p-3 texto open">
        ...
        <div class="col-md-4 p-3 ">
            <h5 class="open fw-bold texto mb-3">With Sojorunplanet, traveling is living unique and memorable experiences. We invite you to explore the world with us and embark on the adventure of a lifetime.</h5>
            <h5 class="open fw-bold">
                What's the trip of your dreams?
            </h5>
            <a href="{{ route('contactgeneral') }}" class="btn btn-outline-dark border border-dark mt-3 patua p-3  rounded-pill">Start to plan my
                trip</a>
        </div>
    </div>
