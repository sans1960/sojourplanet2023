        ...
        <div class="row">
            <div class="col-md-8 mx-auto">
                ...
                <figure class="figure mt-3">
                    <img src="{{ Storage::url($sight->image) }}" class="figure-img img-fluid  d-block mx-auto"
                        alt="...">
                ...
                <div class=" mt-4 d-flex flex-row flex-wrap justify-content-center align-items-center">
                    ...
                    @foreach ($sight->tags as $tag)
                        <a href="{{ route('tagsights', $tag) }}"
                            class="me-2 nav-link text-dark patua">{{ $tag->name }} |</a>
                    @endforeach
                    @endif
                ...
                <div class=" d-flex justify-content-center mt-5 mb-5">
                    <a href="{{ route('contactsight', $sight) }}" class="btn btn-outline-dark border border-dark  patua px-3 py-2 rounded-pill" >Plan a trip here</a>
                </div>
