...
<div class="container">
    <div class="row">
        <div class="col-md-8 mx-auto mt-5 mb-5">
            <p class="open texto">When you travel with us, our goal is to deliver the experience you've envisioned. To
                achieve this, we'll need to collect
                some personal information from you. We understand the importance of keeping your personal information
                secure, and we
                commit to being transparent about how we collect, share, and store your data. Rest assured, we
                prioritize your privacy
                and will handle your information with the utmost care and responsibility, ensuring that it is used only
                for providing
                you with the best possible travel experience.</p>
            <p class="open texto">When planning your travel with us, we'll request necessary information to ensure your
                trip is personalized and
                comfortable. This includes:</p>
            <p class="open texto"> <span class="fw-bold">1-Name and Contact Information:</span> Essential for booking
                confirmations and necessary communications.</p>
            <p class="open texto"><span class="fw-bold">2-Email Address</span> Used for sending itineraries, updates,
                and promotional offers, if you opt-in.</p>
            <p class="open texto"><span class="fw-bold">3-Passport Details:</span> Required for international travel
                bookings and ensuring compliance with global travel regulations.</p>
            <p class="open texto"><span class="fw-bold">4-Dietary Requirements and Medical Conditions:</span> Important
                for accommodating health-related needs and preferences throughout your journey.</p>
            <p class="open texto">We retain this information after your trip concludes to assist with any post-trip
                inquiries and to facilitate planning
                future travels, ensuring a seamless experience each time you choose to travel with us. Your data is
                stored securely and
                used respectfully, adhering to privacy laws and regulations to protect your personal information.</p>
            <p class="open texto">We collect your personal data for several key reasons, all aimed at enhancing your
                experience and providing you with
                tailored services:</p>
            <p class="open texto"><span class="fw-bold">1-Optimizing Your Experience:</span> We use your data to improve
                your interactions with our website or mobile/tablet apps. By understanding your interests
                and the devices you use, we can offer a more personalized and responsive service.</p>
            <p class="open texto"><span class="fw-bold">2-Effective Communication:</span> Your contact details are
                essential for us to reach out to you successfully. Whether you contact us with queries or
                request information, we need your email, mail, telephone number, or instant messaging details to provide
                timely
                responses.</p>
            <p class="open texto"><span class="fw-bold">3-Travel Planning:</span> When organizing your trip, it's
                crucial that we have all necessary information to make appropriate arrangements. This
                includes understanding your preferences, travel requirements, and any special needs you might have.</p>
            <p class="open texto"><span class="fw-bold">4-Personalized Recommendations:</span> Based on your previous
                inquiries and bookings, we can offer you holiday ideas that align with your interests. This
                proactive approach ensures we present you with options that are more likely to appeal to you, enhancing
                your overall
            ...
            <p class="open texto">We collect your personal information either directly from you or, with your explicit
                ...
                we gather only
                the information necessary to enhance your experience and provide you with customized services.</p>
            <p class="open texto">When it comes to sharing your personal information, we do so only when necessary to
                offer you the best possible service,
                whether you're making inquiries or actually traveling with us. For example, we may need to share your
                details with
                airlines, hotels, or other partners involved in delivering your travel arrangements.</p>
            <p class="open texto">Further specifics about how we share your personal information, including the
                safeguards we have in place to protect
                your data, are detailed in Section 3 of our privacy policy. This section outlines the circumstances
                under which your
            ...
            <p class="open texto">We take the security of your personal information very seriously. When processing and
                ...
                committed to
                ensuring that your personal data is handled securely and with respect.</p>
            <p class="open texto">Furthermore, we retain your personal information only for as long as necessary to
                fulfill the purposes for which it was
                collected. This includes the duration of our relationship with you, as well as any additional period as
                required by law
                or as needed to resolve disputes or enforce our agreements. Once it is no longer necessary to retain
                your data, we
            ...
            <p class="open texto"><span class="fw-bold">1-For Questions or Concerns:</span> If you have any questions,
                ...
                personal information, please feel free to contact us at any time. You can reach us by sending an email
                to <a href="mailto:dataprotection@sojournplanet.com">dataprotection@sojournplanet.com.</a></p>
            <p class="open texto"><span class="fw-bold">2-Opting Out of Email Marketing:</span> f you decide that you no
                longer wish to receive marketing emails from us, you can unsubscribe at any time. Simply click
                the 'unsubscribe' link found in the footer of any marketing email we send.</p>
            <p class="open texto"><span class="fw-bold">3-Updating or Erasing Your Data:</span> If your personal
                information changes or if you would like it to be erased from our systems, please send a request to <a
                    href="mailto:dataprotection@sojournplanet.com">dataprotection@sojournplanet.com.</a>
                We will promptly update or remove your information in accordance with your wishes and
                applicable laws.</p>
            ...
            <p class="open texto">We regularly review our privacy policy to ensure it remains up-to-date and reflects
                ...
                our website.
                Additionally, where appropriate, we will inform you directly via email. This approach ensures that you
                are always aware
            ...
            <p class="open texto">At Sojournplanet LLC, we prioritize the protection and respect of your privacy while
                ...
                accuracy of the
                personal information we collect about you. Our systems and processes are designed to ensure that the
                information we
            ...
            <p class="open texto">This privacy policy, along with any documents referenced herein, outlines how we
                ...
                tablet applications,
                as well as any other individuals whose data we handle in the course of conducting our business. We
                encourage you to read
                this policy thoroughly to understand our practices regarding your personal data and how we will treat
                it. This document
            ...
            <p class="open texto">When you interact with us by making an inquiry or requesting a brochure, we collect
                ...
                collect and how we
                use it:</p>
            <p class="open texto"><span class="fw-bold">1-Name and Contact Information:</span> We collect your name,
                email, phone number, and postal address to communicate with you and send you the requested
                materials.</p>
            <p class="open texto"><span class="fw-bold">2-Interest and Preferences:</span> We gather details about the
                destinations and countries you are interested in, along with the specific brochures you
                request, to provide tailored information suited to your travel preferences.</p>
            <p class="open texto"><span class="fw-bold">3-Geographic Location:</span> Understanding your location helps
                us offer relevant travel suggestions and logistical arrangements.</p>
            <p class="open texto"><span class="fw-bold">4-Travel Plans:</span> Additional details you provide about your
                travel plans enable us to offer more personalized service and recommendations.</p>
            <p class="open texto"><span class="fw-bold">5-Communication Preferences:</span> We note the best times to
                contact you and any preferences you have for in-person appointments to ensure our interactions
                are convenient for you.</p>
            <p class="open texto"><span class="fw-bold">6-Reasons for Contacting Us:</span> Knowing what prompted you to
                reach out helps us understand your needs better and improve our service offerings.</p>
            ...
            <p class="open texto">We process this information based on our legitimate interest in providing effective
                ...
                solutions and
                planning an ideal holiday. We balance our business needs with your rights and interests, ensuring that
                your privacy is respected and that you can manage your
            ...
            <p class="open texto"> <span class="fw-bold">1-Passport Details:</span> Necessary for international travel
                bookings and compliance with global travel regulations.</p>
            <p class="open texto"><span class="fw-bold">2-Emergency Contacts:</span> To ensure we can respond
                appropriately in case of emergencies during your travels.</p>
            <p class="open texto"><span class="fw-bold">3-Travel Insurance Arrangements:</span> To verify that you have
                adequate coverage for your journey.</p>
            <p class="open texto"><span class="fw-bold">4-Special Preferences and Requirements:</span> Such as dietary
                needs or accessibility requirements, to ensure your comfort during the trip.</p>
            <p class="open texto"><span class="fw-bold">5-Frequent Flyer Club Membership and Visa Requirements:</span>
            ...
            <p class="open texto"><span class="fw-bold">2-Legitimate Interest:</span> If you are included in a booking
                made by another passenger, it is in our legitimate interest to use your information to
            ...
            <p class="open texto">We may retain your personal information to simplify future bookings, as part of our
                ...
                effectively,
                ensuring we maintain high service standards and recognize the needs of regular travelers.</p>
            <p class="open texto">This structured approach to collecting and utilizing personal information underscores
            ...
            <p class="open texto"> <span class="fw-bold">1-Device and Access Information:</span> This includes the IP
                address or other device identifiers, your browser type and version (e.g., Chrome, Edge), and your
                operating system and platform (e.g., Windows, macOS).</p>
            <p class="open texto"><span class="fw-bold">2-Usage Details:</span> We record the screen resolution of your
                device, the dates and times of your access, and the full URLs of the pages you
                visit. We also track the websites or links you used to access our site and your login information.</p>
            ...
            <p class="open texto"> <span class="fw-bold">1-Business Necessity:</span> We collect this technical
                ...
                ensuring
                information is relevant to users, and improving overall user satisfaction.</p>
            <p class="open texto"> <span class="fw-bold">2-Client Satisfaction and Troubleshooting:</span> By analyzing
                how clients interact with our site, we can identify areas for improvement, troubleshoot issues more
                efficiently, and ensure a positive user experience.</p>
            <p class="open texto"> <span class="fw-bold">3-Consent:</span> For certain types of cookies and tracking
                technologies, we may also seek and rely on your consent, following our cookie
                policy and applicable laws.</p>
            <p class="open texto">This technical data helps us to not only maintain the quality and security of our
                website but also to adapt and refine
            ...
            <p class="open texto"> <span class="fw-bold">1-Contact Details and Preferences:</span> We collect your
                contact information, such as your name, email address, postal address, and phone number, alongside your
                marketing preferences. This enables us to send you communications that may interest you, such as our
                latest travel news,
                expert inspiration, and special offers.</p>
            <p class="open texto"> <span class="fw-bold">2-Interaction and Behavioral Data:</span> We analyze data from
                your interactions with our marketing materials, including responses and behaviors observed through
            ...
            <p class="open texto"> <span class="fw-bold">1-Consent:</span> Where required by law, particularly in
                ...
                on your explicit consent to contact you.</p>
            <p class="open texto"> <span class="fw-bold">2-Legitimate Interests:</span> In situations not specifically
                covered by consent requirements, we operate based on legitimate interests to conduct
            ...
            <p class="open texto">2- Responding with “STOP” to any SMS message.</p>
            <p class="open texto">3- Contacting us directly at dataprotection@sojournplanet.com to adjust your
                preferences or opt-out.</p>
            <p class="open texto">By providing these options, we ensure that you maintain control over how your personal
            ...
            <p class="open texto"> <span class="fw-bold">2-Feedback and Improvement:</span> To gather valuable feedback
            ...
            <p class="open texto"> <span class="fw-bold">2-Legitimate Interests:</span> For activities like market
                research through surveys, we may process your data based on our legitimate interests in
                gaining insights that help us enhance our service offerings and customer experiences. In such cases, we
                carefully
            ...
            <p class="open texto"> <span class="fw-bold">1-Withdraw Consent:</span> You can withdraw your consent at any
                time where consent is the basis of processing. This can be done by contacting us
                directly at a designated email or via communication channels provided at the point of data collection.
            </p>
            <p class="open texto"> <span class="fw-bold">2-Opt-Out of Marketing Communications:</span> Similar to other
                marketing activities, you can opt-out of receiving promotional messages by following the unsubscribe
                instructions included in each communication.</p>
            <p class="open texto">By establishing clear procedures and legal bases for these activities, we ensure
            ...
            <p class="open texto"> <span class="fw-bold">1-Respond to Interactions:</span> We aim to provide timely and
                ...
                or feedback about our services.</p>
            ...
            <p class="open texto"> <span class="fw-bold">1-Legitimate Interests:</span> We process this information
                ...
                on real-time
                feedback.</p>
            <p class="open texto"> <span class="fw-bold">2-Contractual Necessities</span> If your social media
                engagement with us is part of fulfilling a contract or organizing service details (for example, if
            ...
            <p class="open texto"> <span class="fw-bold">1-Data Handling Practices:</span> Our interactions and data
                processing through social media are conducted transparently and securely, maintaining the
                highest level of confidentiality and respect for your privacy.</p>
            <p class="open texto"> <span class="fw-bold">2-Engagement Options:</span> You control how you engage with us
                on social media and can adjust your privacy settings on various platforms to manage
                visibility and the data you share.</p>
            ...
            <p class="open texto"> <span class="fw-bold">1-Enhance Customer Support:</span> Monitor and improve the
                ...
                evaluation to ensure you receive competent and helpful service.</p>
            <p class="open texto"> <span class="fw-bold">2-Provide Accurate Advice:</span> Ensure that our travel
            ...
            <p class="open texto"> <span class="fw-bold">1-Transparency:</span> We inform you when calls are being
                recorded or when interactions are logged, providing you with clear information about
                these practices.</p>
            <p class="open texto"> <span class="fw-bold">2-Security:</span> All recordings and logs are stored securely,
                with access restricted to authorized personnel only.</p>
            <p class="open texto"> <span class="fw-bold">3-Control:</span> You have the right to request access to any
                personal information we hold about you, including recordings and chat logs.
                You can also request correction or deletion of your information if it is inaccurate or has been
                processed in violation
                of privacy regulations.</p>
            ...
            <p class="open texto"> <span class="fw-bold">1-Legitimate Interests:</span> We process this information
                ...
                you and other clients with an optimal experience.</p>
            ...
            <p class="open texto"> <span class="fw-bold">1-Data Handling Practices:</span> We handle your information
                transparently, securely, and with the utmost respect for your privacy.</p>
            <p class="open texto"> <span class="fw-bold">2-Minimization and Relevance:</span> We only collect
                information that is directly relevant and necessary to address the specific issue or feedback you
                provide.</p>
            <p class="open texto"> <span class="fw-bold">3-Rights to Access and Control:</span> You have the right to
                access any personal information we hold about you, and you can request that we update, correct, or
                delete any information, especially if it is inaccurate.</p>
            <p class="open texto">By responsibly managing the information you provide for specific purposes, we aim to
            ...
            <p class="open texto"> <span class="fw-bold">1-Health Conditions:</span> Information relevant to your
                physical or mental health that may affect your travel experience.</p>
            <p class="open texto"> <span class="fw-bold">2-Disabilities and Mobility Requirements:</span> Details about
                any disabilities or mobility issues to ensure accessibility and adequate support during your travels.
            </p>
            ...
            <p class="open texto"> <span class="fw-bold">1-Vital Interests:</span> In emergency situations, we may
                ...
                particularly if you are incapable of giving consent.</p>
            ...
            <p class="open texto"> <span class="fw-bold">1-Consent:</span> We ask that you confirm you have obtained the
                necessary consent from these individuals to share their personal data with
                us.</p>
            ...
            <p class="open texto">This section of our privacy policy ensures transparency in how we handle sensitive
            ...
            <p class="open texto">You have the right to know how your data is being used and shared. You can request
                ...
                opt out of
                certain data sharing practices, you can contact us directly for assistance.</p>
            <p class="open texto">By carefully managing the sharing of your personal information, we aim to maintain
            ...
            <p class="open texto">We retain your personal information only for as long as necessary to fulfill the
                ...
                obligations. For instance:</p>
            <p class="open texto"> <span class="fw-bold">-Transaction Information:</span> Certain data related to
                transactions may be retained for extended periods to comply with financial, tax, and regulatory
                requirements</p>
            <p class="open texto"> <span class="fw-bold">-Client Interaction Records:</span> Information from client
                interactions may be kept for a period to facilitate customer service and relationship
                management.</p>
            <p class="open texto">For specific details about retention periods for different types of personal data, or
                to inquire about our data
                retention practices, please reach out to our Data Protection Officer at <a
                    href="mailto:dataprotection@sojournplanet.com">dataprotection@sojournplanet.com.</a></p>
            <p class="open texto">By adhering to these structured policies and practices, we ensure that your data is
                managed responsibly, kept secure,
            ...
            <p class="open texto"> <span class="fw-bold">-(b) Rectification:</span> If any personal data we hold about
                you is inaccurate or incomplete, you have the right to have it corrected or completed.</p>
            <p class="open texto"> <span class="fw-bold">-(c) Prevention of Processing:</span> You can ask us to stop or
                refrain from processing your personal information if it is causing or is likely to cause
                unwarranted damage or distress to you or others.</p>
            <p class="open texto"> <span class="fw-bold">-(d) Erasure:</span> You can request the deletion of your
                personal information from our systems if there is no valid reason for us to keep
                using it.</p>
            <p class="open texto"> <span class="fw-bold">-(e) Restriction:</span> You can request that we restrict the
                processing of your personal information under certain conditions.</p>
            <p class="open texto"> <span class="fw-bold">-(f) Data Portability:</span> You have the right to receive a
                copy of the personal information you have provided to us in a structured, commonly used,
                and machine-readable format. You can also request that we transfer this information to another party.
            </p>
            <p class="open texto"> <span class="fw-bold">-(g) Objection:</span> You can object to the processing of your
                personal information, particularly for direct marketing purposes or when the
                processing involves sensitive personal information.</p>
            <p class="open texto"> <span class="fw-bold">-(h) Automated Decisions and Profiling:</span> You have the
                right to not be subject to decisions based solely on automated processing, including profiling, which
                has
                legal or similarly significant effects on you.</p>
            ...
            <p class="open texto">If you have any questions, concerns, comments, requests, or complaints regarding this
                ...
                information, or your interactions with our website, please do not hesitate to reach out to us at <a
                    href="mailto:dataprotection@sojournplanet.com">dataprotection@sojournplanet.com.</a>
                We are committed to addressing your inquiries and resolving any issues promptly and
                transparently.</p>
            <p class="open texto">By providing clear channels for communication and complaints, we aim to maintain
                transparency and trust with our
                clients, ensuring that your rights are respected and your concerns are addressed effectively.</p>
