                ...
                <ul class="navbar-nav align-items-center mx-auto">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="nav-item">
                                <a class="dropdown-item" href="{{ route('taylor') }}">Tailor-made-trips</a>
                            </li>
                            <li class="nav-item">
                                <a class="dropdown-item" href="{{ route('dream') }}">The trip of your dreams</a>
                            </li>
                        </ul>
                      </li>
                      @include('front.layouts.destinations', [
                       ...
                       <li class="nav-item">
                        <a class="nav-link" href="{{ route('alltours') }}">Travel Tour</a>
                    </li>
                    {{-- <li class="nav-item">
    ...
    <footer class="bg-dark">
        <div class="container p-2">
            <div class="row">
                ...
                <div class="col-md-3 d-flex justify-content-center align-items-center">
                    <a href="https://sojournplanet.com/images-copyright" class="nav-link text-white"
                        target="_blank">Images Copyright</a>
                </div>
                <div class="col-md-3 d-flex justify-content-center align-items-center">
            ...
            <div class="row mt-5 patua">
                ...
                <div class="col-md-4 d-flex justify-content-center align-items-center">
                    ...
                    <a href="https://sojournplanet.com/terms-and-conditions" target="_blank"
                        class="text-white nav-link">Terms and Conditions</a>
                </div>

                <div class="col-md-4 d-flex justify-content-center align-items-center">
                    <a href="https://sojournplanet.com/privacy-policy" target="_blank" class="nav-link text-white"
