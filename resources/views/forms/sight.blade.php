...
@section('content')
<div class="container-fluid  d-flex justify-content-center align-items-center"  style="background-image: url({{ Storage::url($sight->country->image)}});height:300px; background-size:cover;background-position:center center;" >
