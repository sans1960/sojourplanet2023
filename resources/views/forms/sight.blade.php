...
<div class="container">
    ...
    <form action="{{route('contactos.sight.store')}}" method="post">
        ...
        <div class="row mt-2">
            <div class="col-md-4 mb-2 open">
                ...
                <select class="form-select " name="country_code_id" aria-label="Default select example">
                    ...
                    <option value="{{$countrycode->id}}" {{ old('country_code_id')==$countrycode->id ? 'selected' : ''
                        }} >{{$countrycode->country}}</option>
                    @endforeach
                </select>
            ...
            <div class="col-md-4 mb-2">
                ...
                <input type="text" value="{{old('zipcode')}}" name="zipcode" class="form-control" id="zipcode"
                    placeholder="Zipcode">
        ...
        <div class="row mt-2">
            ...
            <div class="col-md-4 open">
                ...
                <select class="form-select mb-3" name="duration">
                    <option> </option>
                    <option value=""></option>
                    <option value="About a week" {{ "About a week"===old('duration') ? 'selected' : '' }}>About a week
                    </option>
                    <option value="Two or three weeks" {{ "Two or three weeks"===old('duration') ? 'selected' : '' }}>
                        Two or three weeks</option>
                    <option value="One month or more" {{ "One month or more"===old('duration') ? 'selected' : '' }}>One
                        month or more</option>
                </select>
            </div>
            <div class="col-md-4 open">
            ...
            <div class="col-md-4 open">
                ...
                <select id="travel" class="form-select mb-3" name="travelers">
                    <option></option>
                    <option value=""></option>
                    <option value="Individual" {{ "Individual"===old('travelers') ? 'selected' : '' }}>Individual
                    </option>
                ...
                <div class="form-check" id="child" style="display: none;">
                    <input class="form-check-input" type="radio" name="children" value="Travel with children" {{
                        (old('children')=='Travel with children' ) ? 'checked' : '' }} id="flexRadioDefault1">
        ...
        <div class="row mt-2">
            ...
            <div class="col-md-3">
                <div class="form-check mt-2">
                    <input class="form-check-input " type="radio" name="type" value="Gourmet" {{ (old('type')=='Gourmet'
                        ) ? 'checked' : '' }} id="flexRadioDefault1">
                    <label class="form-check-label open " data-bs-toggle="tooltip"
            ...
            <div class="col-md-4 open">
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1" {{
                        (old('romantic')=='Romantic trip' ) ? 'checked' : '' }} name="romantic" value="Romantic trip">
                ...
                <div class="col-md-12  mt-3 mb-3">
                    ...
                    <div class="form-check mt-3">
                        <input class="form-check-input" name="sights[]" type="checkbox" value="{{ $item->site }}" {{ (
                            is_array(old('sights')) && in_array($item->site, old('sights')) ) ? 'checked ' : '' }}
                        id="flexCheckDefault">
                        <label class="form-check-label" for="flexCheckDefault">
                            {{ $item->site }}
                        </label>
            ...
            <div class="row mb-3 mt-3">
                ...
                <div class="col-md-12 d-flex flex-wrap mt-3">
                    ...
                    <div class="form-check me-4">
                        <input class="form-check-input" type="checkbox" name="countries[]" value="{{$country->name}}" {{
                            ( is_array(old('countries')) && in_array($country->name, old('countries')) ) ? 'checked ' :
                        '' }} id="">
