...
<div class="container-fluid  d-flex justify-content-center align-items-center"
  style="background-image:linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url({{ Storage::url($tour->image)}});height:300px; background-size:cover;background-position:center center;">

  <h4 class="text-white patua">Planning the tour</h4>
            ...
            <div class="col-md-4 open">
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" id="inlineCheckbox2" {{
                  (old('mobility')=='Reduced mobility' ) ? 'checked' : '' }} name="mobility" value="Reduced mobility">
