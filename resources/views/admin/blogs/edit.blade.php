                    ...
                    <form action="{{ route('admin.blogs.update',$blog)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                          ...
                          <div class="row mb-3">
                                   ...
                                   <option selected>Choose Category Blog</option>
                                    @foreach ($categoryblogs as $categoryblog)
                                       <option value="{{ $categoryblog->id}}"
                                        @if ($blog->category_blog_id == ($categoryblog->id)) selected
                            ...
                            <div class="col">
                                <input id="" class="form-control" value="{{$blog->date}}" type="date" name="date"/>
                            </div>
                         </div>
                          <div class="row mb-3">
                            <div class="col-md-4 mx-auto">
                                <img  id="preview-image-before-upload" class="img-fluid d-block mx-auto" src="{{Storage::url($blog->image)}}" alt="">
                            </div>
                        </div>
                          <div class="mb-3">
                          ...
                          <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="caption"  name="caption"  value="{{$blog->caption}}">
                          </div>
                          <div class="mb-3">
