                ...
                <div class="card-body">
                    <form action="{{ route('admin.experiences.update',$experience) }}" method="post"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="name" value="{{$experience->name}}" name="name">
                        </div>
                        <div class="mb-3">
                            <label for="slug" class="form-label">Slug</label>
                            <input type="text" class="form-control" id="slug" name="slug" value="{{$experience->slug}}">
                        </div>
                        <div class=" row mb-3">
                            <div class="col">
                            ...
                            <div class="col">
                                <select name="country_id" id="country" class="form-select ">
                                    <option selected value="{{$experience->country_id}}">{{ $experience->country->name}}
                                    </option>
                                </select>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-4 mx-auto">
                                <img id="preview-image-before-upload" class="img-fluid d-block mx-auto"
                                    src="{{Storage::url($experience->image)}}" alt="">
                            </div>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="caption" value="{{$experience->caption}}"
                                name="caption">
                        </div>
                        <div class="mb-3">
