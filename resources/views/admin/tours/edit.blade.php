        ...
        <div class="card-body">
          <form action="{{ route('admin.tours.update',$tour)}}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="title" value="{{$tour->title}}" name="title">
            </div>
            <div class="mb-3">
              <label for="subtitle" class="form-label">Subtitle</label>
              <input type="text" class="form-control" id="subtitle" value="{{$tour->subtitle}}" name="subtitle">
            </div>
            ...
            <div class=" row mb-3">
              ...
              <div class="col">
                <select class="form-select " name="type_id" id="dest">
                  ...
                  <option value="{{ $type->id }}" @if ($tour->type_id == ($type->id)) selected @endif>{{ $type->name }}
                  </option>
                  @endforeach
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-4 mt-2">
                <div class="form-check">
                  <input class="form-check-input" checked name="destinations[]" type="checkbox"
              ...
              <div class="col-md-4 mt-2">
                <div class="form-check">
                  <input class="form-check-input" name="destinations[]" type="checkbox" value="{{$destination->id}}"
                    id="flexCheckDefault">
                  <label class="form-check-label" for="flexCheckDefault">
                    {{$destination->name}}
                  </label>
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-4 mt-2">
                <div class="form-check">
                  <input class="form-check-input" checked name="countries[]" type="checkbox" value="{{$country->id}}"
                    id="flexCheckDefault">
                  <label class="form-check-label" for="flexCheckDefault">
                    {{$country->name}}
                  </label>
              ...
              @foreach ($diffcountries->sortBy('name') as $country)
              <div class="col-md-4 mt-2">
                <div class="form-check">
            ...
            <div class="mb-3 row">
              ...
              <div class="col-md-3 mt-2">
                <div class="form-check">
                  <input class="form-check-input" checked name="ratios[]" type="checkbox" value="{{$ratio->id}}"
                    id="flexCheckDefault">
                  <label class="form-check-label" for="flexCheckDefault">
              ...
              <div class="col-md-4 mt-2">
                <div class="form-check">
                  <input class="form-check-input" name="ratios[]" type="checkbox" value="{{$ratio->id}}"
                    id="flexCheckDefault">
                  <label class="form-check-label" for="flexCheckDefault">
                    {{$ratio->name}} {{$ratio->value}}
                  </label>
            ...
            <div class="row mb-3">
              <div class="col">
                ...
                <input type="text" class="form-control" name="maplatitud" id="" placeholder="Center Latitud Map Tour"
                  value="{{$tour->maplatitud}}">
              </div>

              <div class="col">
                <input type="text" class="form-control" name="maplongitud" id="" placeholder="Center Longitud Map Tour"
                  value="{{$tour->maplongitud}}">
              </div>
            </div>
            <div class="row mb-3">
              <div class="col-md-4 mx-auto">
                <img id="preview-image-before-upload" class="img-fluid d-block mx-auto"
                  src="{{Storage::url($tour->image)}}" alt="">
              </div>
            </div>
            <div class="mb-3">
